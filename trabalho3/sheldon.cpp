/*  Program para implementacao de um bot simples que fala sobre os signos do zodiaco
    Felipe P Ferreira 102017
    02/12/2020
*/

/*  Esse prgrama foi desenvolvido de maneira personalizada, seu bot ou "anfitriao" é um personagem da serie americana THE BIG BANG THEORY
    Devido a isso as frases e replicas do programa contem referencias e marcas caracteristicas da serie
*/
#include <iostream>
#include <ctime>
#include <cstring>
